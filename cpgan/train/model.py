...
if __name__ == "__main__":
    gen = Generator()
    dis = Discriminator()
    # c= dis(torch.rand(10,1,128,128,128),torch.ones(10,1))
    # print(c.shape)

    batch_size = 5
    
    # print( 'The generator architecture is'+'\n{}'.format( summary(gen,[(batch_size,100),(batch_size,1)]) ) )
    print( 'The discriminator architecture is'+'\n{}'.format( summary(dis,[(batch_size,1,128,128,128),(batch_size,1)]) ) )
